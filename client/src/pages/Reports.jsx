    ...
    <div className="fade-in space-y-6">
      ...
      <div className="grid grid-cols-4 gap-4">
        <div className="card text-center">
          <div className="text-[12px] text-text-muted uppercase">Net P&L</div>
          <div className="text-2xl font-bold mono mt-1" style={{color:pnlColor(fy.totalPnL)}}>{fmt$(fy.totalPnL)}</div>
          <div className="text-[12px] text-text-muted">{getFYLabel(activeFY)}</div>
        </div>
        <div className="card text-center">
          <div className="text-[12px] text-text-muted uppercase">Trades</div>
          <div className="text-2xl font-bold mono mt-1 text-white">{fy.count}</div>
          <div className="text-[12px] text-text-muted">{fy.wins}W / {fy.losses}L ({fy.ba}%)</div>
        </div>
        <div className="card text-center">
          <div className="text-[12px] text-text-muted uppercase">Profit Factor</div>
        ...
        <div className="card text-center">
          <div className="text-[12px] text-text-muted uppercase">Avg Win / Loss</div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="card">
          ...
          <table className="w-full text-sm">
            <thead><tr className="text-[12px] text-text-muted uppercase tracking-wider"><th className="text-left py-2">Strategy</th><th className="text-right py-2">P&L</th><th className="text-center py-2">Trades</th><th className="text-center py-2">BA%</th></tr></thead>
            <tbody>
        ...
        <div className="card">
          ...
          <table className="w-full text-sm">
            <thead><tr className="text-[12px] text-text-muted uppercase tracking-wider"><th className="text-left py-2">Underlying</th><th className="text-right py-2">P&L</th><th className="text-center py-2">Trades</th><th className="text-center py-2">BA%</th></tr></thead>
            <tbody>
        ...
        <div className="grid grid-cols-2 gap-8">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              <div><label className="text-[12px] text-text-faint">Platform fees</label><input type="number" step="any" value={feeData.platform||''} onChange={e=>setFeeData(p=>({...p,platform:parseFloat(e.target.value)||0}))} className="w-full px-2 py-1 bg-bg border border-[#21262d] rounded text-xs text-white mono outline-none" placeholder="0"/></div>
              <div><label className="text-[12px] text-text-faint">Other fees</label><input type="number" step="any" value={feeData.other||''} onChange={e=>setFeeData(p=>({...p,other:parseFloat(e.target.value)||0}))} className="w-full px-2 py-1 bg-bg border border-[#21262d] rounded text-xs text-white mono outline-none" placeholder="0"/></div>
            </div>
          </div>
        </div>
      </div>
